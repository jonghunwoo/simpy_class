...
if __name__ == "__main__":
    ...
    for i in range(blocks):
        ...
        while process_time_1 <= 0:
            process_time_1 = st.uniform.rvs(21,2)
            #process_time_1 = st.weibull_min.rvs(c=0.4669, loc=0, scale=10)
        while process_time_2 <= 0:
            process_time_2 = st.uniform.rvs(21,2)
